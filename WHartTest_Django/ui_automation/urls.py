...
from .views import (
    ...
    ActuatorViewSet, UiBatchExecutionRecordViewSet, upload_ai_artifact, upload_screenshot, upload_trace,
    trigger_batch_execution, UiElementMapViewSet, UiAiGenerationTaskViewSet
)
...
router.register('element-maps', UiElementMapViewSet, basename='ui-element-maps')
router.register('ai-generation-tasks', UiAiGenerationTaskViewSet, basename='ui-ai-generation-tasks')
...
urlpatterns = router.urls + [
    ...
    path('artifacts/upload/', upload_ai_artifact, name='ui-ai-artifact-upload'),
